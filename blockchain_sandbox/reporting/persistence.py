...
def _write_summary_json(path: Path, result: AgenticSimulationResult, report: AgenticReport) -> None:
    payload: Dict[str, Any] = {
        ...
        "ds_attempts": report.ds_attempts,
        "ds_success_count": report.ds_success_count,
        "ds_reorg_reverts": report.ds_reorg_reverts,
        "ds_public_confirmed_count": report.ds_public_confirmed_count,
        "ds_conflict_released_count": report.ds_conflict_released_count,
        "ds_confirmed_and_released_count": report.ds_confirmed_and_released_count,
        "ds_reverts_on_released_count": report.ds_reverts_on_released_count,
        "merchant_loss_total": report.merchant_loss_total,
        "attacker_net_profit": report.attacker_net_profit,
        "economy_enabled_effective": report.economy_enabled_effective,
        "selfish_hash_power_share": report.selfish_hash_power_share,
        "selfish_economic_share": report.selfish_economic_share,
        "selfish_ratio_economic": report.selfish_ratio_economic,
        "selfish_net_profit_total": report.selfish_net_profit_total,
        "network_net_profit_total": report.network_net_profit_total,
        "selfish_initial_capital_total": report.selfish_initial_capital_total,
        "selfish_roi": report.selfish_roi,
        "ratio_economic_signed": report.ratio_economic_signed,
        "strategy_constrained_rate": report.strategy_constrained_rate,
        "persona_deviation_rate": report.persona_deviation_rate,
        "fallback_to_strategy_rate": report.fallback_to_strategy_rate,
        "persona_deviation_impact_delta": report.persona_deviation_impact_delta,
        "strategy_action_distribution": report.strategy_action_distribution,
        "raw_action_dist": report.raw_action_dist,
        "effective_action_dist": report.effective_action_dist,
        "executed_action_dist": report.executed_action_dist,
        "audit_consistency": report.audit_consistency,
        "audit_mismatch_count": report.audit_mismatch_count,
        "wasted_honest_blocks": report.wasted_honest_blocks,
        "published_selfish_orphan_blocks": report.published_selfish_orphan_blocks,
        "unpublished_selfish_blocks": report.unpublished_selfish_blocks,
        "headline_metrics": {
        ...
        "miner_details": [
            {
                ...
                "economic_net_profit": d.economic_net_profit,
                "economic_roi": d.economic_roi,
                "economic_share": d.economic_share,
                "economic_vs_hp_ratio": d.economic_vs_hp_ratio,
                "top_actions": d.top_actions,
                "last_raw_action": d.last_raw_action,
                "last_effective_action": d.last_effective_action,
                "last_executed_action": d.last_executed_action,
            ...
            writer.writerow(
                {
                    ...
                    "economic_net_profit": f"{d.economic_net_profit:.8f}",
                    "economic_roi": f"{d.economic_roi:.8f}",
                    "economic_share": f"{d.economic_share:.8f}",
                    "economic_vs_hp_ratio": f"{d.economic_vs_hp_ratio:.8f}",
